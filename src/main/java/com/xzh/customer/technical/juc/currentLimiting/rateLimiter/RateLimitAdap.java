...
import com.xzh.customer.technical.juc.currentLimiting.ResponseUtil;
...
public class RateLimitAdap {
    ...
    @Pointcut("@annotation(com.xzh.customer.technical.juc.currentLimiting.rateLimiter.RateLimitAnnotation)")
