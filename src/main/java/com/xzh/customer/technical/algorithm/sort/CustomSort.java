...
public class CustomSort {
    ...
    public static void main(String[] args) {
        ...
        //根据省份排序
        students.sort((o1, o2) -> {
            int index1 = regulationOrder.indexOf(o1.getProvence());
            if (index1 == -1)
                return 1;
            int index2 = regulationOrder.indexOf(o2.getProvence());
            if (index2 == -1)
                return -1;
        ...
        for (int i = 0; i < students.size(); i++) {
            System.out.println(students.get(i).getProvence() + "------" + sortedList.get(i).getProvence());
