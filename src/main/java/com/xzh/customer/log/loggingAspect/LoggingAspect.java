package com.xzh.customer.log.loggingAspect;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.xzh.customer.log.loggingAspect.PerformanceLog) || @annotation(com.xzh.customer.log.loggingAspect.PerformanceLog)")
